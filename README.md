...
## Описание задачи
В ходе исследования мы проверяли гипотезу на основе данных из RLMS: более высокий доход родителей напрямую влияет на физическое здоровье детей. Семьи с высоким доходом могут обеспечить своим детям лучший доступ к медицинскому обслуживанию, что способствует их физическому благополучию.
...
Для просмотра работы можете открыть файл исследования напрямую в этом репозитории:
![Click](./Practicum_3_6_(9).ipynb)
